<template>
    <div class="set-post-invalid">
        ...
        <div class="set-post-invalid-content">
            <div class="set-post-invalid-information"  @click="spreadPost(index)">
                <Card :bordered="false">
                    <p slot="title">帖子1</p>
                ...
                <div class="card-footer">
                    ...
                    <p>关注人数：20</p>
                    <p class="set-to-invalid">标注为无效</p>
                </div>
            </div>
            <div class="set-post-invalid-information"  @click="spreadPost(index)"  v-for="(item,index) in postList">
                <Card :bordered="false">
                    <p slot="title">帖子{{item.name}}</p>
                    <p slot="extra">2018/12/28 12:00:00</p>
                    <div class="part-set-post-invalid-information">
                        <p>房屋地址：广东省广州市天河区五山街道308号</p>
                        <p>房屋大小：100平方米</p>
                        <p>房屋类型：2室1厅1卫</p>
                        <p>出租价格：2000元/月</p>
